document.addEventListener('DOMContentLoaded', () => {
      ...
      function startMatrixAnimation() {
        ...
        matrixAnimation.textContent = 'BUILD YOUR EMPIRE BEFORE 30';
      ...
      // Newsletter Button
      document.querySelector('.newsletter-container button').addEventListener('click', () => {
        const email = document.querySelector('.newsletter-container input[type="email"]').value;
        if (email && email.includes('@')) {
          alert('🔥 Welcome to the WealthForge Tzeptosoft! Check your email for confirmation.');
          document.querySelector('.newsletter-container input[type="email"]').value = '';
        } else {
